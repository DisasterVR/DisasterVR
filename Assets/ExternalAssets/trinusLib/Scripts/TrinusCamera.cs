...
//		public float defaultViewAngle = 0;
        ...
        public void setMode(CAMERA_MODE mode)
        {
            ...
            // Desactivar la VR
            UnityEngine.XR.XRSettings.enabled = false; // Esta línea desactivará la VR para todas las plataformas
            ...
            switch (mode)
            {
                ...
                case CAMERA_MODE.UNITY_VR:
                    ...
                    // Puedes activar la VR específica aquí si es necesario, o simplemente dejarla desactivada
